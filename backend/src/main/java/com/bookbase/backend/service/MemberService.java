...
public class MemberService {
    ...
    public Member registerMember(MemberDTO newMemberDTO) {
        ...
        newMember.setPassword(encoder.encode(newMemberDTO.getPassword())); // never log password
    ...
    public Member updateMember(int id, MemberDTO memberDTO) {
        ...
        if (memberDTO.getPassword() != null) existingMember.setPassword(memberDTO.getPassword()); // don’t log
